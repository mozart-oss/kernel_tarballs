...
# process
.PHONY: gups nas gas was ttf pscomm ascomm bastet bstopenssl
gups: $(MOUDULES)
...
.PHONY: clean-gups clean-nas clean-gas clean-was clean-ttf clean-pscomm clean-ascomm clean-bastet clean-bstopenssl
